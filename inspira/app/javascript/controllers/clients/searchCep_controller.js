            ...
            if (!field.value) {
                switch (field) {
                    case this.streetTarget:
                        fieldNames.push('Logradouro campo obrigatório')
                        break
                    case this.neighborhoodTarget:
                        fieldNames.push('Bairro campo obrigatório')
                        break
                    case this.cityTarget:
                        fieldNames.push('Cidade campo obrigatório')
                        break
                    case this.cepTarget:
                        fieldNames.push('CEP campo obrigatório')
                        break
                    case this.add_numberTarget:
                        fieldNames.push('Número campo obrigatório')
                        break
                    case this.ufTarget:
                        fieldNames.push('UF campo obrigatório')
                        break
                }
