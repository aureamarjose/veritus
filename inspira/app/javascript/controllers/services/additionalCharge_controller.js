...
export default class extends Controller {
  static targets = ["inputLauchDate", "inputReleaseDescription", "inputLauchValue", "template", "table", "message", "total", "totalCost", "fields", "myElement"]
  ...
  calculateTotal() {
    ...
    this.totalCostTarget.textContent = formattedTotal
